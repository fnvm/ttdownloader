...
public class UrlResolver {
  public static String resolveShortUrl(String shortLink)
  ...
  /**
   * Heuristically infers the content type from the link. The result is not guaranteed to be
   * accurate and may be incorrect, particularly for story content.
   */
