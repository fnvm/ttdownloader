...
import static org.github.fnvm.telegram.action.ActionType.*;

public class Actions {
    private static final Pattern TIKTOK_URL_PATTERN =
            Pattern.compile("^https://(vt\\.tiktok\\.com|www\\.tiktok\\.com|vm\\.tiktok\\.com)/.*");
