...
public class CookieHandler {
  ...
  public void handleSetCookie(Long chatId, Long userId, String cookies) {
    if (cookies == null || cookies.isBlank()) {
      sender.sendMessage(chatId, "Usage: /setcookie <sessionid>");
      return;
    }

    profileManager.setCookies(userId, cookies);
    sender.sendMessage(chatId, "Cookies have been set");
  }

  public void handleViewCookie(Long chatId, Long userId) {
    profileManager
        .getCookies(userId)
        .ifPresentOrElse(
